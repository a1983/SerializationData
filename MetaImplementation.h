...
#define MD_GET_FIELD_COUNT_IMPL( _0, _1, _2, _3, _4, _5, N, ... ) N
#define MD_GET_FIELD_COUNT( ... ) MD_EXP( MD_GET_FIELD_COUNT_IMPL( __VA_ARGS__, 5, 4, 3, 2, 1, 0 ) )
...
#define MD_VISIT_E( name, field ) m.template visit< decltype( name::field ), &name::field > ( #field )
#define MD_VISIT_ALL_I( name, field ) MD_VISIT_E( name, field );
#define MD_VISIT_ALL( N, name, ... ) MD_FOR_EACH_N( N, MD_VISIT_ALL_I, MD_VISIT_E, name, __VA_ARGS__ )

#define MD_VISIT_IF_I( name, field ) MD_VISIT_E( name, field ) &&
#define MD_VISIT_IF( N, name, ... ) MD_FOR_EACH_N( N, MD_VISIT_IF_I, MD_VISIT_E, name, __VA_ARGS__ )
